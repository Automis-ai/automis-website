...
const page = () => {
  ...
  return (
    <AkpagerLayout header={8} footer={1} bodyClass={"home-nine"}>
      ...
      <section
        id="home"
        className="hero-padding bg-deep-blue relative z-10"
      >
            ...
            <div className="w-full lg:w-1/2 px-4 mb-12 lg:mb-0">
              ...
              >
                ...
                >
                  ...
                  Into{" "}
                  <span className="text-text-blue">Appointments</span>
                </h2>
                ...
                <p className="body-text !text-text-muted">Built For You, Not By You</p>
        ...
        <div className="hero-nine-shapes">
          <div className="shape one">
            <img src="assets/images/shapes/hero-nine.png" alt="Background decorative shape" loading="lazy" className="!bg-transparent"/>
          </div>
      ...
      <section id="demo" className="py-20 relative z-20 bg-bg-primary">
          ...
          <div className="flex justify-center">
            ...
            >
              <div className="text-center mb-12">
                ...
                <h2 className="section-heading text-white" data-aos="fade-up" data-aos-duration="800">
              ...
              >
                <div className="flex flex-col lg:flex-row lg:items-start justify-between max-w-6xl mx-auto">
                    ...
                    >
                      ...
                      <ul className="space-y-3 mb-8 text-center lg:!text-left">
                        <li className="flex items-center justify-center lg:justify-start body-text text-text-light">
                          <i className="fal fa-check text-yellow-light mr-3" /> Increase Appointment
                          Booking Rate by 18%
                        </li>
                        <li className="flex items-center justify-center lg:justify-start body-text text-text-light">
                          <i className="fal fa-check text-yellow-light mr-3" /> Time-Saving with
                  ...
                  <div className="w-full lg:w-[40%] order-2 lg:order-2">
                    ...
                    >
                      <img src="assets/images/tabs/tab-two.png" alt="AI Voice Assistant managing outbound calls interface" className="w-full max-w-[350px] rounded-lg hidden lg:block" loading="lazy" />
                    </div>
                  </div>
                </div>
              </Tab.Pane>
                ...
                <div className="flex flex-col lg:flex-row lg:items-center justify-between  max-w-6xl mx-auto">
                  <div className="w-full lg:w-[60%] mb-8 lg:mb-0 order-1 lg:order-1">
                    <div className="content pr-0 lg:pr-12 text-center lg:!text-left">
                      ...
                      <ul className="space-y-3 mb-8 text-center lg:!text-left">
                        <li className="flex items-center justify-center lg:justify-start body-text text-text-light">
                          <i className="fal fa-check text-yellow-light mr-3" /> 24/7 automated booking
                          management
                        </li>
                        <li className="flex items-center justify-center lg:justify-start body-text text-text-light">
                          <i className="fal fa-check text-yellow-light mr-3" /> Quick responses to
                          customer inquiries
                        </li>
                      </ul>
                      <CTAButton
                  ...
                  <div className="w-full lg:w-[40%] order-2 lg:order-2">
                    <div className="hidden lg:flex justify-center lg:justify-end !bg-transparent">
                      <img src="assets/images/tabs/tab-inbound.png" alt="AI receptionist handling inbound calls and bookings interface" className="w-full max-w-[350px] rounded-lg hidden lg:block" loading="lazy" />
                    </div>
                  </div>
                </div>
              </Tab.Pane>
           ...
           <div className="flex justify-center">
            <div className="w-full xl:w-3/4 lg:w-11/12">
              <div
                ...
                data-aos-offset={50}
              >
                <h2 className="section-heading text-white mb-4">Industries <br className="sm:hidden" /> We Serve</h2>
                <p className="sub-heading text-white/90">
                   Automis AI is purpose-built for any appointment-driven business that can't afford to miss a call.Our 24/7 voice AI receptionist plugs into your existing calendar and CRM to instantly convert every lead into a booked appointment—day or night, in 20+ languages.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="flex flex-wrap justify-center -mx-4">
                ...
                <div className="bg-blue-darkest/30 backdrop-blur-lg border border-blue-middle/20 rounded-2xl p-8 hover:bg-yellow-light/30 hover:border-yellow-light/30 transition-all duration-300 group relative overflow-hidden h-full flex flex-col">
                  <div className="flex items-center mb-6">
                    <div className="w-16 h-16 bg-blue-middle/20 rounded-xl flex items-center justify-center group-hover:bg-yellow-light/20 transition-all duration-300">
                      <img src="/assets/images/icon-box/tooth.svg" alt="Dental and healthcare industry icon" className="w-8 h-8 filter brightness-0 invert group-hover:brightness-100 transition-all duration-300" loading="lazy" />
                    </div>
                  </div>
                  <div className="relative z-10 flex-grow">
                    ...
                    <p className="body-text text-white/90 group-hover:text-text-light transition-colors duration-300">
                      24/7 live call-answering and fully automated appointment booking
              ...
              >
                <div className="bg-blue-darkest/30 backdrop-blur-lg border border-blue-middle/20 rounded-2xl p-8 hover:bg-yellow-light/30 hover:border-yellow-light/30 transition-all duration-300 group relative overflow-hidden h-full flex flex-col">
                  <div className="flex items-center mb-6">
                    <div className="w-16 h-16 bg-blue-middle/20 rounded-xl flex items-center justify-center group-hover:bg-yellow-light/20 transition-all duration-300">
                      <img src="/assets/images/icon-box/house.svg" alt="Home services and interventions industry icon" className="w-8 h-8 filter brightness-0 invert group-hover:brightness-100 transition-all duration-300" loading="lazy" />
                    </div>
                  </div>
                  <div className="relative z-10 flex-grow">
                    <h4 className="card-heading text-white mb-3 group-hover:text-yellow-light transition-colors duration-300">
                    ...
                    <p className="body-text text-white/90 group-hover:text-text-light transition-colors duration-300">
                      ...
                      <br/>Real-time two-way calendar sync to maximize technician utilization
                    </p>
                  </div>
                  <div className="absolute inset-0 bg-gradient-to-br from-transparent to-yellow-light/5 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                </div>
              ...
              >
                <div className="bg-blue-darkest/30 backdrop-blur-lg border border-blue-middle/20 rounded-2xl p-8 hover:bg-yellow-light/30 hover:border-yellow-light/30 transition-all duration-300 group relative overflow-hidden h-full flex flex-col">
                  <div className="flex items-center mb-6">
                    <div className="w-16 h-16 bg-blue-middle/20 rounded-xl flex items-center justify-center group-hover:bg-yellow-light/20 transition-all duration-300">
                      <img src="/assets/images/icon-box/houses.svg" alt="Real estate industry icon" className="w-8 h-8 filter brightness-0 invert group-hover:brightness-100 transition-all duration-300" loading="lazy" />
                    </div>
                  </div>
                  <div className="relative z-10 flex-grow">
                    <h4 className="card-heading text-white mb-3 group-hover:text-yellow-light transition-colors duration-300">
                    ...
                    <p className="body-text text-white/90 group-hover:text-text-light transition-colors duration-300">
                      After-hours property tour scheduling for every single inquiry
                      <br/>Hot-lead alerts routed to your top agents
                    </p>
                  </div>
                  <div className="absolute inset-0 bg-gradient-to-br from-transparent to-yellow-light/5 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                </div>
              ...
              >
                <div className="bg-blue-darkest/30 backdrop-blur-lg border border-blue-middle/20 rounded-2xl p-8 hover:bg-yellow-light/30 hover:border-yellow-light/30 transition-all duration-300 group relative overflow-hidden h-full flex flex-col">
                  <div className="flex items-center mb-6">
                    <div className="w-16 h-16 bg-blue-middle/20 rounded-xl flex items-center justify-center group-hover:bg-yellow-light/20 transition-all duration-300">
                      <img src="/assets/images/icon-box/hand.svg" alt="Beauty and wellness industry icon" className="w-8 h-8 filter brightness-0 invert group-hover:brightness-100 transition-all duration-300" loading="lazy" />
                    </div>
                  </div>
                  <div className="relative z-10 flex-grow">
                    <h4 className="card-heading text-white mb-3 group-hover:text-yellow-light transition-colors duration-300">
                    ...
                    <p className="body-text text-white/90 group-hover:text-text-light transition-colors duration-300">
                      Smart, automated bookings for salons, spas, and med-aesthetic clinics
                      <br/>No-show reduction with call/SMS confirmations
                    </p>
                  </div>
                  <div className="absolute inset-0 bg-gradient-to-br from-transparent to-yellow-light/5 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                </div>
              ...
              >
                <div className="bg-blue-darkest/30 backdrop-blur-lg border border-blue-middle/20 rounded-2xl p-8 hover:bg-yellow-light/30 hover:border-yellow-light/30 transition-all duration-300 group relative overflow-hidden h-full flex flex-col">
                  <div className="flex items-center mb-6">
                    <div className="w-16 h-16 bg-blue-middle/20 rounded-xl flex items-center justify-center group-hover:bg-yellow-light/20 transition-all duration-300">
                      <img src="/assets/images/icon-box/car.svg" alt="Automotive and repair industry icon" className="w-8 h-8 filter brightness-0 invert group-hover:brightness-100 transition-all duration-300" loading="lazy" />
                    </div>
                  </div>
                  <div className="relative z-10 flex-grow">
                    <h4 className="card-heading text-white mb-3 group-hover:text-yellow-light transition-colors duration-300">
                    ...
                    <p className="body-text text-white/90 group-hover:text-text-light transition-colors duration-300">
                      Live dispatch for breakdowns, MOTs, routine service and urgent repair calls
                      <br/>Dynamic slot-optimization – to boost bay throughput
                    </p>
                  </div>
                  <div className="absolute inset-0 bg-gradient-to-br from-transparent to-yellow-light/5 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                </div>
              ...
              >
                <div className="bg-blue-darkest/30 backdrop-blur-lg border border-blue-middle/20 rounded-2xl p-8 hover:bg-yellow-light/30 hover:border-yellow-light/30 transition-all duration-300 group relative overflow-hidden h-full flex flex-col">
                  <div className="flex items-center mb-6">
                    <div className="w-16 h-16 bg-blue-middle/20 rounded-xl flex items-center justify-center group-hover:bg-yellow-light/20 transition-all duration-300">
                      <img src="/assets/images/icon-box/handshake.svg" alt="White-label and agencies partnership icon" className="w-8 h-8 filter brightness-0 invert group-hover:brightness-100 transition-all duration-300" loading="lazy" />
                    </div>
                  </div>
                  <div className="relative z-10 flex-grow">
                    <h4 className="card-heading text-white mb-3 group-hover:text-yellow-light transition-colors duration-300">
                    ...
                    <p className="body-text text-white/90 group-hover:text-text-light transition-colors duration-300">
                      Fully brandable voice-AI receptionist you can resell under your own name
                      <br/>Plug-and-play integration — no coding, no extra headcount
                    </p>
                  </div>
                  <div className="absolute inset-0 bg-gradient-to-br from-transparent to-yellow-light/5 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                </div>
              ...
              <Tab.Pane className="tab-pane fade" eventKey="tabThree1">
                <div className="flex flex-wrap items-center justify-around">
                  <div className="w-full xl:w-1/3 lg:w-5/12 mb-8 lg:mb-0 order-1 lg:order-1">
                    ...
                    >
                      <div className="mb-5">
                        <h3 className="sub-heading text-white text-2xl md:text-3xl">Stay Informed with Real-Time Monitoring</h3>
                      </div>
                      ...
                      <ul className="space-y-4 my-8">
                        <li className="flex items-start">
                          ...
                          <span className="body-text text-text-light">Track all ongoing
                          interactions from one unified dashboard.</span>
                        </li>
                        <li className="flex items-start">
                          <i className="fal fa-check text-yellow-light mt-1 mr-3 flex-shrink-0" />
                          <span className="body-text text-text-light">Receive alerts and
                          notifications ensuring seamless operations.</span>
                        </li>
                      </ul>
                      <CTAButton
                        href="https://api.leadconnectorhq.com/widget/booking/3Nvnzsvjaw89VWsdBBXF"
              ...
              <Tab.Pane className="tab-pane fade" eventKey="tabThree2">
                <div className="flex flex-wrap items-center justify-around">
                  <div className="w-full xl:w-1/3 lg:w-5/12 mb-8 lg:mb-0 order-1 lg:order-1">
                    ...
                    >
                      <div className="mb-5">
                        <h3 className="sub-heading text-white text-2xl md:text-3xl">Access Detailed Logs for Every Conversation</h3>
                      </div>
                      <p className="body-text text-white/90 mb-6">
                      ...
                      <ul className="space-y-4 my-8">
                        <li className="flex items-start">
                          <i className="fal fa-check text-yellow-light mt-1 mr-3 flex-shrink-0" />
                          <span className="body-text text-text-light">View and search call
                          histories</span>
                        </li>
                        <li className="flex items-start">
                          <i className="fal fa-check text-yellow-light mt-1 mr-3 flex-shrink-0" />
                          <span className="body-text text-text-light">Download and filter
                          logs</span>
                        </li>
                      </ul>
                      <CTAButton
                  ...
                  <div className="w-full xl:w-1/3 lg:w-5/12 mb-8 lg:mb-0 order-2 lg:order-2 mt-8 md:mt-12 lg:mt-0">
                    ...
                    >
                      ...
                      <ul className="space-y-4 my-8">
                        <li className="flex items-start">
                          <i className="fal fa-check text-yellow-light mt-1 mr-3 flex-shrink-0" />
                          <span className="body-text text-text-light">Monitor key metrics
                          such as CRR and CSAT.</span>
                        </li>
                        <li className="flex items-start">
                          <i className="fal fa-check text-yellow-light mt-1 mr-3 flex-shrink-0" />
                          <span className="body-text text-text-light">Identify successes with
                          visual reports and trend analysis.</span>
                        </li>
                      </ul>
                      <CTAButton
                        href="https://api.leadconnectorhq.com/widget/booking/3Nvnzsvjaw89VWsdBBXF"
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="flex justify-center">
            <div className="w-full xl:w-2/3 lg:w-11/12">
              ...
              >
                ...
                <p
                  className="sub-heading text-white/90"
                >
          ...
          <div className="flex flex-wrap justify-center items-center -mx-4">
            ...
            <div className="w-full xl:w-5/12 md:w-full px-4 mb-8">
              ...
              >
                <div className="content">
                  <h4 className="card-heading text-blue-middle mb-4">
                    Humans
                  </h4>
                  <ul
                    className="space-y-2.5"
        ...
        faqs={[
          {
            ...
            answer: "Think of our Voice AI as a super-smart virtual assistant for your business. It can handle customer calls, book appointments, answer questions, and even make sales calls - all while sounding surprisingly human-like. It's like having an extra team member who never sleeps!"
          },
          {
            question: "Can it really understand what customers are saying?",
            answer: "You bet! Our Voice AI is pretty brainy. It uses advanced tech to understand context, accents, and even industry jargon. It's not just hearing words - it's getting the meaning behind them. So whether your customer has a thick accent or uses lots of technical terms, our AI's got it covered."
          },
          {
            question: "Will it work with the systems we already use?",
            answer: "Absolutely! We've designed our Voice AI to play nice with others. It can integrate with your CRM, calendar, and other business tools. Our team will help set everything up so it fits right into your current workflow. No need to overhaul your entire system!"
          },
          {
            question: "What if the AI gets stumped by a question?",
            answer: "No worries! While our AI is pretty smart, we know it can't handle everything. If it encounters a question it can't answer, it'll smoothly hand the call over to a human agent. Your customers will always get the help they need, one way or another."
          },
          {
            question: "How do we keep track of how well it's doing?",
            answer: "We've got you covered with a nifty analytics dashboard. It shows you all sorts of useful stuff - call volumes, how many issues get resolved, customer satisfaction scores, and more. It's like having a bird's eye view of your customer interactions, helping you spot trends and areas for improvement."
          }
        ]}
      />
      <section
      ...
      >
        <div className="container mx-auto px-4">
          <div className="flex justify-center">
            ...
            >
              <div
                className="bg-blue-darkest/30 backdrop-blur-lg border-2 border-yellow-light rounded-2xl p-16 shadow-lg shadow-yellow-light/20 hover:scale-[1.02] transition-all duration-300"
              >
                <div className="mb-10">
                  <span
                    className="inline-block bg-yellow-light/20 text-yellow-light px-6 py-2 rounded-full small-text font-semibold mb-6"
                  >
