      ...
      >
        <div className="bg-gradient-to-r from-blue-darkest to-blue-middle shadow-2xl">
          <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
            <span className="text-white font-semibold text-lg">Scale your Business With AI </span>
            <div className="flex gap-4">
              <Link href="#demo" className="bg-yellow-light text-blue-darkest px-6 py-2 rounded-full font-semibold hover:bg-yellow-dark hover:text-white transition-colors inline-flex items-center">
              <i
