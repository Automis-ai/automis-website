...
export default function AdvancedTechSection() {
  ...
  const features = [
    {
      icon: Brain,
      title: "🇩🇪 Perfektes Deutsch",
      text: "Versteht regionale Akzente, Redewendungen und natürliche Sprache. Die KI klingt wie eine muttersprachliche Stimme.",
    },
    {
      icon: Link2,
      title: "🔗 Native Integrationen",
      text: "Direkte Anbindung an CRM, Kalender und Branchensoftware.",
    },
    {
      icon: BarChart3,
      title: "📊 Analytics in Echtzeit",
      text: "Umfassendes Dashboard mit Kennzahlen und ROI-Tracking.",
    },
    {
      icon: Target,
      title: "🎯 Vollständige Personalisierung",
      text: "Skripte und Tonfall passgenau für Ihre Marke und Branche.",
    },
    {
      icon: ShieldCheck,
      title: "🔒 Sicherheit & DSGVO",
      text: "Verschlüsselte Daten, EU-Server, vollständige DSGVO-Konformität.",
    },
    {
      icon: Rocket,
      title: "🚀 Unbegrenzte Skalierbarkeit",
      text: "Bewältigen Sie tausende Anrufe ohne Limits oder Fixkosten.",
    },
  ];
      ...
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold mb-4 leading-snug text-white">
            ...
            <span className="text-text-blue">einfache Nutzung</span>
          </h2>
          <p className="text-blue-light/80 max-w-3xl mx-auto text-base md:text-lg">
            Die volle Power der Künstlichen Intelligenz – einfach und
            zugänglich für jedes deutsche Unternehmen.
          </p>
        </div>
