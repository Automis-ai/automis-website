...
export default function TestimonialsSection() {
  ...
  const testimonials = [
    {
      rating: 5,
      text: "En 6 mois, nous avons réactivé des leads pour 754 000 €. L’IA appelle mieux que mon équipe.",
      author: "Jean Dupont — CEO, Immobilier Paris",
      delay: 100,
    },
    {
      rating: 5,
      text: "Plus aucun appel manqué. Les patients réservent même à 23 h. +6 k€ de revenus par mois.",
      author: "Dr Sophie Martin — Cabinet Dentaire Lyon",
      delay: 200,
    },
    {
      rating: 5,
      text: "Nous avons éliminé 40 % des no-shows. L’IA gère 200 réservations/semaine.",
      author: "Pierre Lefèvre — Restaurant Marseille",
      delay: 300,
    },
  ];
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-white leading-snug">
            Entreprises françaises qui nous font confiance
          </h2>
          <p className="text-blue-light/80 max-w-2xl mx-auto text-base md:text-lg">
            Découvrez comment les entreprises françaises révolutionnent déjà la
            gestion client avec Automis Voice AI.
          </p>
        </div>
        ...
        >
          <iframe
            ref={iframeRef}
            src="https://api.leadconnectorhq.com/widget/bookings/automis-fr"
            title="Réservez une démo Automis"
