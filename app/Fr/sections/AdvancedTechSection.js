...
export default function AdvancedTechSection() {
  ...
  const features = [
    {
      icon: Brain,
      title: "🇫🇷 Français Parfait",
      text: "Compréhension avancée des accents régionaux, des expressions idiomatiques et du langage naturel. L'IA parle comme un natif français.",
    },
    {
      icon: Link2,
      title: "🔗 Intégrations Natives",
      text: "Connexion directe avec les CRM, calendriers et logiciels de gestion français.",
    },
    {
      icon: BarChart3,
      title: "📊 Analyses en Temps Réel",
      text: "Tableau de bord complet avec métriques et suivi du ROI.",
    },
    {
      icon: Target,
      title: "🎯 Personnalisation Totale",
      text: "Scripts et ton adaptés à votre marque et à votre secteur.",
    },
    {
      icon: ShieldCheck,
      title: "🔒 Sécurité & RGPD",
      text: "Données chiffrées, serveurs UE, conformité totale au RGPD.",
    },
    {
      icon: Rocket,
      title: "🚀 Scalabilité Illimitée",
      text: "Gérez des milliers d'appels sans limites ni coûts fixes.",
    },
  ];
      ...
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold mb-4 leading-snug text-white">
            Technologie Avancée,{" "}
            <span className="text-text-blue">Simplicité d’Utilisation</span>
          </h2>
          <p className="text-blue-light/80 max-w-3xl mx-auto text-base md:text-lg">
            Toute la puissance de l’intelligence artificielle, rendue simple et
            accessible pour chaque entreprise française.
          </p>
        </div>
