...
export const metadata = {
  ...
  openGraph: {
    ...
    description:
      "Guarda i sistemi IA che abbiamo costruito per clienti veri: una segretaria IA attiva 24/7 e un'automazione contatti su Meta. Fatti concreti, non promesse.",
  ...
  twitter: {
    ...
    title: "Casi studio Automis | Sistemi IA reali per clienti veri, già attivi",
    description:
      "Guarda i sistemi IA che abbiamo costruito per clienti veri: una segretaria IA attiva 24/7 e un'automazione contatti su Meta.",
  },
};
