...
export const metadata = {
  title: "Contatti | Parliamo del tuo progetto IA | Automis",
  description:
    "Contatta Automis. Scrivici un messaggio o prenota una call conoscitiva di 30 minuti: ti mostriamo dove l'IA può farti recuperare tempo, chiamate e fatturato.",
  keywords: [
    "contatti Automis",
    "consulenza automazione IA",
    "call conoscitiva IA",
    "partner automazione IA",
  ],
  alternates: {
    canonical: "https://automis.ai/it/contact",
    languages: {
  ...
  openGraph: {
    title: "Contatti Automis | Parla con un partner strategico di automazione IA",
    description:
      "Scrivici un messaggio o prenota una call conoscitiva. Individuiamo dove la tua azienda perde tempo e denaro, poi costruiamo i sistemi IA per risolverlo.",
    url: "https://automis.ai/it/contact",
    siteName: "Automis",
    locale: "it_IT",
    type: "website",
  ...
  twitter: {
    ...
    title: "Contatti Automis",
    description:
      "Scrivici un messaggio o prenota una call conoscitiva con un partner strategico di automazione IA.",
  },
};
          ...
          <div className="mx-auto max-w-3xl pt-32 pb-12 text-center sm:pt-36 md:pt-40">
            ...
            <Reveal delay={80} immediate>
              <h1 className="font-display mx-auto mt-6 max-w-[18ch] text-[2.4rem] font-bold leading-[1.08] tracking-[-0.02em] text-white sm:text-[3.2rem] md:text-[3.6rem]">
                Parliamo del <GradientText>sistema che ti manca</GradientText>.
              </h1>
            </Reveal>
            <Reveal delay={160} immediate>
              <p className="mx-auto mt-6 max-w-xl text-[1.05rem] leading-relaxed text-white/65 md:text-[1.15rem]">
                Scrivici un messaggio o scegli un orario sul calendario. Individuiamo dove la tua
                azienda perde tempo e denaro, poi ti mostriamo le opportunità di IA che vale la pena costruire.
              </p>
            </Reveal>
          </div>
        </div>
