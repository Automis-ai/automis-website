...
const page = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setFormStatus({
        ...
        success: false,
        error:
          "Invio non riuscito. Riprova oppure contattaci direttamente.",
      });
  ...
  const quickLinks = [
    { title: "Richiedi il tuo AI Audit", href: "/jumpstart-audit", icon: "🎯" },
    { title: "I nostri servizi", href: "/", icon: "🚀" },
  ];
  ...
  const testimonials = [
    {
      ...
      role: "CEO, TechCorp",
      content:
        "Automis ha trasformato il nostro customer service con le sue soluzioni AI. I tempi di risposta sono diminuiti del 70% e la soddisfazione clienti è aumentata in modo netto.",
      rating: 5,
    },
    {
      name: "Sarah Miller",
      role: "COO, RetailPlus",
      content:
        "L’AI audit ha evidenziato opportunità che non avevamo mai considerato. L’implementazione è stata fluida e il ROI è stato evidente nel giro di poche settimane.",
      rating: 5,
    },
  ];
      ...
      <section className="relative min-h-[400px] bg-gradient-to-br from-section-dark to-bg-primary overflow-hidden">
        ...
        <div className="relative z-10 flex items-center justify-center px-4">
          <div className="text-center max-w-5xl mx-auto pt-48 pb-28">
            ...
            >
              Parliamo di come far <br /> crescere il tuo business
            </h1>
            <p
              ...
              data-aos-duration={1000}
            >
              Vuoi trasformare la tua azienda con l’AI? <br /> Siamo qui per aiutarti
              a ottenere una crescita concreta.
            </p>
          </div>
        </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      <label className="block text-base font-semibold text-white mb-2">
                        Nome e Cognome <span className="text-bright-blue">*</span>
                      </label>
                      <input
                        type="text"
                        name="name"
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      <label className="block text-base font-semibold text-white mb-2">
                        Telefono{" "}
                        <span className="text-white/90 text-xs">(opzionale)</span>
                      </label>
                      <input
                        type="tel"
                        name="phone"
                  ...
                  <div>
                    <label className="block small-text font-semibold text-white mb-2">
                      Oggetto <span className="text-bright-blue">*</span>
                    </label>
                    <input
                      type="text"
                      name="subject"
                  ...
                  <div>
                    <label className="block small-text font-semibold text-white mb-2">
                      Messaggio <span className="text-bright-blue">*</span>
                    </label>
                    <textarea
                      name="message"
                      required
                      ...
                      placeholder="Raccontaci cosa ti serve, obiettivi e contesto..."
                    />
                  </div>
                  ...
                  <div>
                    <label className="block small-text font-semibold text-white mb-2">
                      ...
                      <span className="text-white/90 text-xs">
                        (opzionale - brief, screenshot, ecc.)
                      </span>
                    </label>
                    <div className="relative">
                      ...
                      >
                        ...
                        <span className="body-text text-white/90">
                          {formData.file ? formData.file.name : "Clicca per caricare un file"}
                        </span>
                      </label>
                    </div>
                  </div>
            ...
            <div className="lg:col-span-5 space-y-8">
              ...
              >
                <div className="bg-gradient-to-r from-blue-darkest to-blue-middle/50 p-6 text-center">
                  ...
                  <h3 className="card-heading text-white mb-2">
                    Vuoi saltare il form?
                  </h3>
                  <p className="body-text text-white/90">Prenota una call ora.</p>
                </div>
          ...
          <div className="mt-20">
            <div className="text-center mb-12">
              <h2 className="section-heading text-white mb-4">
                Scelto da leader di settore
              </h2>
              <p className="body-text text-white/90">
                Unisciti a centinaia di aziende che stanno trasformando i processi con l’AI
              </p>
            </div>
                ...
                >
                  <div className="flex gap-1 mb-4">
                    {[...Array(testimonial.rating)].map((_, i) => (
                      <Star
                        key={i}
                        className="w-5 h-5 fill-yellow-light text-yellow-light"
                      />
                    ))}
                  </div>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className="body-text text-white font-semibold">
                        {testimonial.name}
                      </p>
