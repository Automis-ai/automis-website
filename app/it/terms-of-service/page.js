...
export const metadata = {
  title: "Termini di servizio | Automis",
  description:
    "I termini che regolano l'uso di automis.ai e dei sistemi e servizi IA forniti da Automis.",
  alternates: {
    canonical: "https://automis.ai/it/terms-of-service",
    languages: {
