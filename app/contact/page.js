  ...
  const testimonials = [
    {
      ...
      role: "CEO, TechCorp",
      content:
        "Automis transformed our customer service with their AI solutions. Response times dropped by 70% and customer satisfaction soared.",
      rating: 5,
    },
    {
      name: "Sarah Miller",
      role: "COO, RetailPlus",
      content:
        "The AI audit revealed opportunities we never knew existed. Implementation was smooth and ROI was evident within weeks.",
      rating: 5,
    },
  ];
        ...
        <div className="relative z-10 flex items-center justify-center px-4">
          <div className="text-center max-w-5xl mx-auto pt-48 pb-28">
            ...
            <p
              ...
              data-aos-duration={1000}
            >
              Ready to transform your business with AI? <br /> We're here to
              help you achieve remarkable growth.
            </p>
          </div>
        </div>
              ...
              >
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="flex items-center space-x-2 p-4 bg-white/5 rounded-lg border border-border-light">
                    ...
                    <label
                      htmlFor="recaptcha"
                      className="small-text text-white/90"
                    >
                      I'm not a robot
                    </label>
                  </div>
