...
const features = [
  {
    ...
    text: "Advanced understanding of accents, idioms and natural, conversational language. The AI speaks like a native English speaker.",
  },
  {
    icon: Link2,
    title: "Native Integrations",
    text: "Direct connection with your CRM, calendars and business tools.",
  },
  {
    icon: BarChart3,
    title: "Real-Time Analytics",
    text: "A complete dashboard with metrics and ROI tracking.",
  },
  {
    icon: Target,
    title: "Full Customisation",
    text: "Scripts and tone tailored to your brand and your industry.",
  },
  {
    icon: ShieldCheck,
    title: "Security & GDPR",
    text: "Encrypted data, EU servers and full GDPR compliance.",
  },
  {
    icon: Rocket,
    title: "Unlimited Scalability",
    text: "Handle thousands of calls with no limits and no fixed costs.",
  },
];
      ...
      <div className="container relative z-10 mx-auto px-4">
        <div className={`av-reveal ${visible ? "is-visible" : ""}`}>
          <SectionHeading
            ...
            title={
              <>
                Advanced technology, <Grad>simple to use</Grad>
              </>
            }
            subtitle="All the power of artificial intelligence, made simple and accessible for your business."
          />
        </div>
