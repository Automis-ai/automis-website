...
const STATS = [
  { end: 72, suffix: "h", label: "To go live" },
  { end: 80, suffix: "%", label: "Of calls handled by AI" },
  { end: 24, suffix: "/7", label: "Available, no breaks or holidays" },
  { end: 100, suffix: "%", label: "Natural English voice" },
];
