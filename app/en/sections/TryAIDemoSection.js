...
export default function TryAIDemoSection() {
  ...
  const suggestions = [
    {
      icon: MessageCircle,
      text: "“How does Automis AI work?”",
      delay: 100,
    },
    {
      icon: BrainCircuit,
      text: "“Which industries do you support?”",
      delay: 200,
    },
    {
      icon: Mic,
      text: "“Can I integrate it with my CRM?”",
      delay: 300,
    },
    {
      icon: Rocket,
      text: "Describe your main challenge and let the AI analyse your case for potential solutions.",
      delay: 400,
    },
  ];
      ...
      <div className="container mx-auto px-4 max-w-5xl text-center relative z-10">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold mb-4 leading-snug text-white">
            Try It Now: Talk to Our AI
          </h2>
          <p className="text-blue-light/80 max-w-2xl mx-auto text-base md:text-lg mb-10">
            Don't just take our word for it. Click below and ask anything about
            our solution. Automis AI will answer in real time, exactly as it
            would with your customers.
          </p>

          <p className="text-blue-300 italic mb-8">
            💬 Click the pop-up in the bottom left and test our AI for free
          </p>
        </div>
