...
const HeroSection = () => {
  return (
    ...
    >
      ...
      {/* --- Capa de gradiente (encima del fondo, debajo del contenido) --- */}
        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          >
            <span className="text-white">
              Tu Asistente de Voz Inteligente <br className="hidden md:block" />
              <span className="text-text-blue">que Trabaja 24/7</span>
            </span>
          </h1>
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <span>Configuración en 72 horas</span>
            </div>
            <div className="flex items-center gap-2">
              <i className="fas fa-check-circle text-yellow-light"></i>
              <span>Cumple con el GDPR</span>
            </div>
            <div className="flex items-center gap-2">
              <i className="fas fa-check-circle text-yellow-light"></i>
