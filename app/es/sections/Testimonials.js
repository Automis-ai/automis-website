...
export default function TestimonialsSection() {
  ...
  const testimonials = [
    {
      rating: 5,
      text: "En 6 meses reactivamos leads por valor de €754.000. La IA llama mejor que mi propio equipo.",
      author: "Carlos Martínez — Director, Inmobiliaria Sevilla Capital",
      delay: 100,
    },
    {
      rating: 5,
      text: "Cero llamadas perdidas. Los pacientes reservan incluso a medianoche. +€6.000 de ingresos al mes.",
      author: "Dra. Laura Gómez — Clínica Dental Valencia",
      delay: 200,
    },
    {
      rating: 5,
      text: "Hemos reducido un 40% las ausencias. La IA gestiona más de 200 reservas por semana.",
      author: "Javier Torres — Propietario, Restaurante El Puerto (Alicante)",
      delay: 300,
    },
  ];
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-white leading-snug">
            Empresas Españolas que Confían en Nosotros
          </h2>
          <p className="text-blue-light/80 max-w-2xl mx-auto text-base md:text-lg">
            Descubre cómo las empresas españolas ya están revolucionando su
            atención al cliente con Automis Voice AI.
          </p>
        </div>
        ...
        >
          <iframe
            ref={iframeRef}
            src="https://api.leadconnectorhq.com/widget/bookings/automis-es"
            title="Reserva una demo de Automis"
