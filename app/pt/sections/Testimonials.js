...
export default function TestimonialsSection() {
  ...
  // Redimensionamento dinâmico opcional se o widget de agendamento enviar altura
  useEffect(() => {
  ...
  const testimonials = [
    {
      rating: 5,
      text: "Em 6 meses reativámos leads no valor de 754 000 €. A IA faz chamadas melhor do que a minha equipa.",
      author: "Marco Silva — CEO, Imobiliária Lisboa",
      delay: 100,
    },
    {
      rating: 5,
      text: "Zero chamadas perdidas. Os pacientes marcam até às 23h. Receita +6 000 €/mês.",
      author: "Dra. Joana Costa — Clínica Dentária Porto",
      delay: 200,
    },
    {
      rating: 5,
      text: "Eliminámos 40% das faltas às marcações. A IA gere mais de 200 reservas por semana.",
      author: "Luís Pereira — Restaurante Lisboa",
      delay: 300,
    },
  ];
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="text-blue-light/80 max-w-2xl mx-auto text-base md:text-lg">
            Veja como as empresas em Portugal já estão a revolucionar a forma
            como gerem os seus clientes com a Automis Voice AI.
          </p>
        </div>
        ...
        {/* Iframe de Agendamento Compacto */}
        <div
        ...
        >
          <iframe
            ...
            title="Marcar uma Demonstração Automis"
