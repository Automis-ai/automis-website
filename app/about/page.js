          ...
          <div className="flex flex-wrap -mx-4 items-center">
            <div className="px-4 lg:w-7/12">
              <div className="relative z-10">
                ...
                <p
                  ...
                  data-aos-delay={200}
                >
                  Three visionaries united by a passion for AI and marketing excellence. Together, we're building the
                  future of automated business growth.
                </p>
            ...
            <div className="px-4 lg:w-5/12 mt-12 lg:mt-0">
              <div className="relative" data-aos="fade-left" data-aos-duration={1500}>
                ...
                <div
                  className="absolute -bottom-4 md:-bottom-8 -right-4 md:-right-8 bg-blue-darkest/30 backdrop-blur-lg border border-blue-middle/20 p-4 md:p-6 rounded-2xl shadow-2xl about-hero-floating-card z-20 hidden sm:block hover:bg-yellow-light/30 hover:border-yellow-light/30 transition-all duration-300"
                ...
                <div className="relative rounded-3xl overflow-hidden shadow-2xl">
                  ...
                  <div className="absolute inset-0 pointer-events-none">
                    ...
                    <div
                      className="absolute top-2/3 left-0 right-0 about-tech-grid-line"
          ...
          <div className="flex flex-wrap -mx-4 items-center mb-20 lg:mb-32">
            ...
            <div className="px-4 lg:w-1/2">
              <div className="pl-0 lg:pl-12" data-aos="fade-left" data-aos-duration={1500}>
                ...
                <h2 className="section-heading text-white font-medium mb-6">Building the Future of AI-Driven Marketing</h2>

                <p className="body-text text-white/90 mb-4">
                  Automis was founded on the belief that artificial intelligence and human expertise work best together.
                  Luca and Arcangelo recognized that many small businesses and startups wanted to leverage AI but lacked
                  the know-how.
                </p>

                <p className="body-text text-white/90 mb-8">
                  They created Automis to combine advanced AI tools with hands-on marketing strategies, making it simple
                  for you to grow and innovate. Today, we're proud to be the bridge between cutting-edge technology and
          ...
          <div className="flex flex-wrap -mx-4 items-center mt-20 lg:mt-32">
            <div className="px-4 lg:w-1/2 mb-8 lg:mb-0 order-2 lg:order-1">
              <div className="pr-0 lg:pr-12" data-aos="fade-right" data-aos-duration={1500}>
                ...
                <h2 className="section-heading text-white font-medium mb-6">Empowering Growth Through Innovation</h2>
                ...
                <p className="body-text text-white/90 mb-12">
                  By translating complex AI technologies into clear, actionable plans, we free you to focus on your
                  customers and accelerate your success. Our approach combines the best of both worlds - cutting-edge
                  AI capabilities with the strategic thinking and creativity that only humans can provide.
                </p>
              </div>
            </div>
      ...
      <section className="section-padding bg-bg-primary">
        <div className="container mx-auto px-4">
          ...
          <div className="flex flex-wrap -mx-4">
            <div className="px-4 xl:w-1/4 lg:w-1/3 sm:w-1/2 mb-8" data-aos="fade-up" data-aos-duration={1000}>
              <div className="bg-blue-darkest/30 backdrop-blur-lg border border-blue-middle/20 rounded-2xl p-8 hover:bg-yellow-light/30 hover:border-yellow-light/30 transition-all duration-300 group h-full text-center hover:transform hover:-translate-y-2">
                ...
                <p className="body-text text-white/90">
                  We continually experiment with the latest AI models and marketing platforms to keep you ahead of the
                  curve.
                </p>
              </div>
            </div>
            ...
            <div
              className="px-4 xl:w-1/4 lg:w-1/3 sm:w-1/2 mb-8"
              data-aos="fade-up"
              data-aos-delay={100}
            ...
            >
              <div className="bg-blue-darkest/30 backdrop-blur-lg border border-blue-middle/20 rounded-2xl p-8 hover:bg-yellow-light/30 hover:border-yellow-light/30 transition-all duration-300 group h-full text-center hover:transform hover:-translate-y-2">
                ...
                <p className="body-text text-white/90">We blend human creativity with machine efficiency to achieve optimal outcomes.</p>
              </div>
            </div>
            ...
            >
              <div className="bg-blue-darkest/30 backdrop-blur-lg border border-blue-middle/20 rounded-2xl p-8 hover:bg-yellow-light/30 hover:border-yellow-light/30 transition-all duration-300 group h-full text-center hover:transform hover:-translate-y-2">
                ...
                <p className="body-text text-white/90">
                  From our first call through monthly reports, we maintain open communication and clear expectations.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="px-4 xl:w-2/3 lg:w-3/4">
              <div className="text-center" data-aos="fade-up" data-aos-duration={1500}>
                ...
                <h2 className="section-heading text-white font-light italic leading-relaxed mb-8">
                  "Our mission is to make sophisticated AI accessible and actionable, turning insights into impact and clicks into clients."
                </h2>
            ...
            <div className="px-4 lg:w-1/2 md:w-1/2 mb-8">
              ...
              >
                <div className="p-8 text-center flex flex-col h-full">
                  ...
                  <p className="text-bright-blue font-medium mb-4">Digital Marketing & AI Growth Strategy</p>
                  <p className="text-base text-white/90 font-open-sans leading-relaxed mb-6">
                    Turns paid traffic into predictable revenue with conversion-first funnels, lead follow-up systems,
                  ...
                  <div className="mt-auto">
                    ...
                    >
                      ...
                      <i className="far fa-arrow-right" style={{ transform: "rotate(-30deg)" }} />
                    </a>
                  </div>
                </div>
              </div>
            ...
            <div className="px-4 lg:w-1/2 md:w-1/2 mb-8">
              ...
              >
                <div className="p-8 text-center flex flex-col h-full">
                  ...
                  <p className="text-base text-white/90 font-open-sans leading-relaxed mb-6">
                    Builds and scales ad systems that improve CAC and ROAS across Meta, Google, and multi-channel acquisition.
                  </p>
          ...
          <div className="flex flex-wrap -mx-4 items-center">
            <div className="px-4 lg:w-2/3">
              <div data-aos="fade-right" data-aos-duration={1500}>
                <h2 className="section-heading text-white font-medium mb-4">Ready to Transform Your Business?</h2>
