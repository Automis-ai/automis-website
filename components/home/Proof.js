  ...
  en: {
    cases: [
      ...
      },
      {
        ...
        tag: "Meta automation",
        result:
          "Comments and DMs on Facebook and Instagram, handled and qualified: 2,329 conversations in five months and 524 complete records, 3 in 10 of which become clients.",
      },
    ],
    stats: [
      { value: "60%", label: "of the clinic's calls closed without reaching the front desk" },
      { value: "3 in 10", label: "of ADifesa's complete records become clients (their figure)" },
    ...
    disclaimer:
      "The 60% and 47% are production data from Clínica Santa Maria and ADifesa; the 3 in 10 is reported by ADifesa from their own system. The launch time is a conservative estimate. Your results depend on volume, market, and setup.",
  },
  it: {
    cases: [
      {
      ...
      },
      {
        ...
        result:
          "Commenti e messaggi su Facebook e Instagram, gestiti e qualificati: 2.329 conversazioni in cinque mesi e 524 schede complete, di cui 3 su 10 diventano clienti.",
      },
    ],
    stats: [
      { value: "60%", label: "delle chiamate alla clinica chiuse senza passare dalla segretaria" },
      { value: "3 su 10", label: "delle schede complete di ADifesa diventa cliente (dato loro)" },
    ...
    disclaimer:
      "Il 60% e il 47% vengono dai dati di produzione della Clínica Santa Maria e di ADifesa; il 3 su 10 lo dichiara ADifesa, dal suo sistema. Il tempo di attivazione è una stima prudente. I tuoi risultati dipendono dal volume, dal mercato e dalla configurazione.",
  },
  pt: {
    cases: [
      {
      ...
      },
      {
        ...
        tag: "Automação Meta",
        result:
          "Comentários e mensagens no Facebook e no Instagram, tratados e qualificados: 2.329 conversas em cinco meses e 524 fichas completas, das quais 3 em cada 10 se tornam clientes.",
      },
    ],
    stats: [
      { value: "60%", label: "das chamadas da clínica resolvidas sem passar pela receção" },
      { value: "3 em 10", label: "das fichas completas da ADifesa torna-se cliente (dado deles)" },
    ...
    disclaimer:
      "Os 60% e os 47% vêm dos dados de produção da Clínica Santa Maria e da ADifesa; os 3 em 10 são declarados pela ADifesa, a partir do sistema deles. O tempo de ativação é uma estimativa prudente. Os seus resultados dependem do volume, do mercado e da configuração.",
  },
};
