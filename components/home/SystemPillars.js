...
const COPY = {
  ...
  it: {
    eyebrow: "Un solo sistema connesso · tre pilastri",
    titlePre: "Non vendiamo strumenti. Costruiamo il ",
    titleGrad: "sistema che fa girare il tuo business",
    titlePost: ".",
    lead: "Il marketing ti porta i clienti. Le vendite fanno in modo che non ne sfugga nessuno. Le operations trasformano tutto in una macchina che cresce senza nuove assunzioni.",
    flagship: "Flagship",
    pillars: [
      {
        kicker: "Marketing & Crescita",
        title: "Sistemi che mandano avanti il tuo marketing",
        body: "Non l'ennesima agenzia che ti gestisce le ads. Sistemi IA che ottimizzano creatività e budget su Meta e Google, ti fanno guadagnare visibilità su Google e nelle ricerche IA, e tengono i contenuti sempre in movimento, da soli.",
        points: ["Ads ottimizzate dall'IA su Meta e Google", "Fatti trovare su Google e nelle ricerche IA (SEO / GEO)", "Workflow per contenuti e reputazione"],
        cta: null,
      },
      {
      ...
      },
      {
        ...
        title: "Il tuo know-how, finalmente a portata di ricerca",
        body: "La parte più difficile da copiare. Un Second Brain su misura sui dati della tua azienda, OCR che trasforma la carta in dati consultabili, e note vocali che si scrivono da sole nel tuo CRM. Lo strato di operations che nessun concorrente può comprare già pronto.",
        points: ["Un cervello consultabile sui tuoi dati (RAG su misura)", "Trasforma carta e PDF in dati (OCR / vision)", "Note vocali scritte da sole nel tuo CRM"],
        cta: null,
      },
    ],
  },
